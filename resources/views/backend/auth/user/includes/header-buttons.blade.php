            ...
            <div class="modal-body">
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="basic-addon1">@lang('labels.backend.access.users.filter.full_name')</span>
                    </div>
                    <input value="{{ @request()->input()['filter']['full_name'] }}" name="filter[full_name]" type="text" class="form-control"/>
                </div>

                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="basic-addon1">@lang('labels.backend.access.users.filter.username')</span>
                    </div>
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="basic-addon1">@lang('labels.backend.access.users.filter.company')</span>
                    </div>
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="basic-addon1">@lang('labels.backend.access.users.filter.confirmed')</span>
                    </div>
