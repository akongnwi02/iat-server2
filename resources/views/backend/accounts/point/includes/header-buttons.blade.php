    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="basic-addon1">@lang('labels.backend.account.filter.company')</span>
                    </div>
                    <input value="{{ @request()->input()['filter']['point.company.name'] }}" name="filter[point.company.name]" type="text" class="form-control"/>
                </div>
