    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="basic-addon1">@lang('labels.backend.points.table.city')</span>
                    </div>
                    <input value="{{ @request()->input()['filter']['city'] }}" name="filter[city]" type="text" class="form-control"/>
                </div>

                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="basic-addon1">@lang('labels.backend.points.table.address')</span>
                    </div>
                    <input value="{{ @request()->input()['filter']['address'] }}" name="filter[address]" type="text" class="form-control"/>
                </div>
