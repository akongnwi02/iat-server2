@can(config('permission.permissions.read_sales'))
    <div class="btn-toolbar float-right" role="toolbar" aria-label="@lang('labels.general.toolbar_btn_groups')">
        ...
        <a href="{{ route('admin.sales.download', request()->except('page')) }}"><span class="btn btn-secondary ml-1" data-toggle="tooltip" title="@lang('labels.backend.sales.filter.download')"><i class="fas fa-download"></i></span><a>
    </div><!--btn-toolbar-->
@endcan
