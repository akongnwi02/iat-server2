            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    <ul class="nav nav-tabs" role="tablist" id="serviceTab">
                        ...
                        {{--<li class="nav-item">--}}
                            {{--<a class="nav-link" data-toggle="tab" href="#supply-points" role="tab" aria-controls="services" aria-expanded="true"><i class="fas fa-cog"></i> @lang('labels.backend.services.service.tabs.titles.supply_points')</a>--}}
                        {{--</li>--}}
                    </ul>
                    ...
                    <div class="tab-content">
                        ...
                        {{--<div class="tab-pane fade" id="supply-points" role="tabpanel" aria-expanded="true">--}}
                            {{--@include('backend.services.service.edit.tabs.supply-points')--}}
                        {{--</div><!--tab-->--}}
                    </div><!--tab-content-->
                </div><!--col-->
            </div><!--row-->
