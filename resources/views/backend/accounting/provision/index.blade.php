...
@section('title', app_name() . ' | ' . __('labels.backend.accounting.commission.management'))
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        @lang('labels.backend.accounting.commission.management')
                    </h4>
                </div><!--col-->
                ...
                <div class="col">
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                            <tr>
                                <th>@lang('labels.backend.accounting.commission.table.service')</th>
                                <th>@lang('labels.backend.accounting.commission.table.commission')</th>
                                <th>@lang('labels.backend.accounting.commission.table.last_request_date')</th>
                                <th>@lang('labels.backend.accounting.commission.table.number_requests')</th>
                            ...
                            @foreach($services as $service)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="@lang('labels.backend.accounting.commission.actions')">
            ...
            <div class="row">
                <div class="col-7">
                    <div class="float-left">
                        {!! $services->total() !!} {{ trans_choice('labels.backend.accounting.commission.table.total', $services->total()) }}
                    </div>
                </div><!--col-->
