...
return [
    ...
    */
    ...
    'unauthorized_company'  => 'Vous n\'êtes pas autorisé à créer un utilisateur dans cette entreprise.',
    'unauthorized_role'     => 'Vous ne pouvez attribuer à un utilisateur qu\'un rôle inférieur au rôle :highest_role',
    'phone_or_email'        => 'Veuillez entrer un numéro de téléphone ou une adresse email valide.',
