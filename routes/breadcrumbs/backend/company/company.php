...
Breadcrumbs::for('admin.companies.company.clone', function ($trail, $id) {
    $trail->parent('admin.companies.company.index');
    $trail->push(__('menus.backend.companies.company.clone'), route('admin.companies.company.clone', $id));
});
