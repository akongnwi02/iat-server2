...
Breadcrumbs::for('admin.payments.electricity.create', function ($trail) {
    $trail->parent('admin.payments.electricity.index');
    $trail->push(__('menus.backend.payments.electricity.create'), route('admin.payments.electricity.create'));
});
